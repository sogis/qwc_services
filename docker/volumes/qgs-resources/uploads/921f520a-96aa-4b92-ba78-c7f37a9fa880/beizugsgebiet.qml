...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="datum_nachfuehrung">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="datum_nachfuehrung" index="2" name=""/>
    <alias field="typ" index="3" name=""/>
    <alias field="geschaeftsnummern" index="4" name=""/>
    <alias field="kantonsnummern" index="5" name=""/>
    <alias field="projekttyp" index="6" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="datum_nachfuehrung"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="datum_nachfuehrung" expression=""/>
