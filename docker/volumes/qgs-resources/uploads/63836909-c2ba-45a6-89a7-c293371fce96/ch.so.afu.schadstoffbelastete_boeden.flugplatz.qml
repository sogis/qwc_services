...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="100000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{9a92ab7f-79d6-4ab5-8d08-6382efdcd8c6}">
      <rule key="{c886f857-bcac-41f1-99c0-b6e923adb1e8}" symbol="0" label="Flughafenareal"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="flugplatzname" index="2" name=""/>
    <alias field="bezeichnung" index="3" name=""/>
    <alias field="astatus" index="4" name=""/>
    <alias field="aktiv" index="5" name=""/>
    <alias field="erfassungsdatum" index="6" name=""/>
    <alias field="datenerfasser" index="7" name=""/>
    <alias field="begruendung_aus_vsb_entlassen" index="8" name=""/>
    <alias field="datum_aus_vsb_entlassen" index="9" name=""/>
    <alias field="bemerkung" index="10" name=""/>
    <alias field="nutzungseinschraenkung" index="11" name=""/>
    <alias field="bfs_gemeindenummern" index="12" name=""/>
    <alias field="gemeindenamen" index="13" name=""/>
    <alias field="grundbuchnummern" index="14" name=""/>
    <alias field="flurnamen" index="15" name=""/>
    <alias field="nutzungsverbot" index="16" name=""/>
    <alias field="status_txt" index="17" name=""/>
    <alias field="begruendung_aus_vsb_entlassen_txt" index="18" name=""/>
  </aliases>
