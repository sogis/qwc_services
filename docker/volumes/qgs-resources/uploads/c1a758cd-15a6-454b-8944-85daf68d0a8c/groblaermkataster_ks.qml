...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="kritperimeter">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{c92766ab-feda-4c97-b391-d27cd09992b4}">
      <rule filter=" &quot;kritperimeter&quot;  = 'kritisch_Grenzwerte_ES_I_und_II'" key="{9f0cda1f-601a-4417-a244-33639024f2f6}" symbol="0" label="kritisch Grenzwerte ES I und II"/>
      <rule filter=" &quot;kritperimeter&quot;  = 'kritisch_Grenzwerte_ES_I_bis_III'" key="{cea23d25-62e8-4919-af7a-9b964cb56c6c}" symbol="1" label="kritisch Grenzwerte ES I, II und III"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="kritperimeter" index="2" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-587380272">
    <columns>
      <column width="-1" hidden="0" type="field" name="t_id"/>
      <column width="-1" hidden="0" type="field" name="t_ili_tid"/>
      <column width="281" hidden="0" type="field" name="kritperimeter"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="kritperimeter" expression=""/>
  </defaults>
