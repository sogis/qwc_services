...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="pdf">
  ...
  <renderer-v2 attr="code" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="10" label="-"/>
      <category render="true" symbol="1" value="11" label="Handlungsbedarf vorhanden, Dringlichkeit klein"/>
      <category render="true" symbol="2" value="12" label="Handlungsbedarf vorhanden, Dringlichkeit mittel"/>
      <category render="true" symbol="3" value="13" label="Handlungsbedarf vorhanden, Dringlichkeit gross"/>
      <category render="true" symbol="4" value="20" label="kein Handlungsbedarf, keine Priorität"/>
      <category render="true" symbol="5" value="99" label="keine Ansprache duchgeführt"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="235,14,232,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="jahr"/>
  ...
  <aliases>
    <alias field="pdf" index="0" name=""/>
    <alias field="jahr" index="1" name=""/>
    <alias field="code" index="2" name=""/>
    <alias field="text" index="3" name=""/>
    <alias field="t_id" index="4" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="pdf"/>
