...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="geologische_einheit">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{4b284626-4014-486c-bfe1-277a44b885c9}">
      <rule filter="&quot;begruendung_aus_vsb_entlassen&quot; is null" key="{2b15a672-9931-43a1-9e76-25151add356c}" symbol="0" label="Verdachtsfläche"/>
      <rule filter="&quot;astatus&quot; = 'Belastung_nachgewiesen' and  &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{ace1a8dd-83a6-4784-ad4e-588c54ca22d7}" symbol="1" label="Belastung nachgewiesen"/>
      <rule filter=" &quot;nutzungseinschraenkung&quot;  =  'true' and &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{f3259737-4242-4a47-996f-c1feb12dd00c}" symbol="2" label="Nutzungseinschränkung"/>
      <rule filter=" &quot;nutzungsverbot&quot;  =  'true' and &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{b2e665e9-21ba-46ad-af9d-1483bca9c571}" symbol="3" label="Nutzungsverbot"/>
    </rules>
    <symbols>
      <symbol alpha="0.996078" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="231,101,34,255"/>
  ...
  <aliases>
    ...
    <alias field="geologische_einheit" index="2" name="Geologische Einheit"/>
    <alias field="bezeichnung" index="3" name="Bezeichnung"/>
    <alias field="astatus" index="4" name="Status"/>
    <alias field="aktiv" index="5" name="aktiv?"/>
    <alias field="erfassungsdatum" index="6" name="Erfasungsdatum"/>
    <alias field="datenerfasser" index="7" name="Erfasser"/>
    <alias field="begruendung_aus_vsb_entlassen" index="8" name="Begründung aus VSB entlassen"/>
    <alias field="datum_aus_vsb_entlassen" index="9" name="Datum aus VSB entlassen"/>
    <alias field="bemerkung" index="10" name="Bemerkung"/>
    <alias field="nutzungseinschraenkung" index="11" name="Nutzungseinschränkung"/>
    <alias field="dokument" index="12" name=""/>
    <alias field="schadstoffe" index="13" name=""/>
    <alias field="bfs_gemeindenummern" index="14" name=""/>
    <alias field="gemeindenamen" index="15" name=""/>
    <alias field="grundbuchnummern" index="16" name=""/>
    <alias field="flurnamen" index="17" name=""/>
    <alias field="nutzungsverbot" index="18" name="Nutzungsverbot"/>
    <alias field="status_txt" index="19" name=""/>
    <alias field="begruendung_aus_vsb_entlassen_txt" index="20" name=""/>
    <alias field="flaeche" index="21" name=""/>
    <alias field="umfang" index="22" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;nutzungsverbot&quot;" sortOrder="1">
    <columns>
      <column width="-1" hidden="0" type="field" name="t_id"/>
      <column width="-1" hidden="0" type="field" name="t_ili_tid"/>
      <column width="-1" hidden="0" type="field" name="geologische_einheit"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Allgemein" groupBox="0" columnCount="1">
      <attributeEditorField showLabel="1" index="3" name="bezeichnung"/>
      <attributeEditorField showLabel="1" index="2" name="geologische_einheit"/>
      <attributeEditorField showLabel="1" index="4" name="astatus"/>
      <attributeEditorField showLabel="1" index="5" name="aktiv"/>
      <attributeEditorField showLabel="1" index="11" name="nutzungseinschraenkung"/>
      <attributeEditorField showLabel="1" index="18" name="nutzungsverbot"/>
      <attributeEditorField showLabel="1" index="10" name="bemerkung"/>
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="&quot;astatus&quot;" name="aus VSB entlassen" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="8" name="begruendung_aus_vsb_entlassen"/>
        <attributeEditorField showLabel="1" index="9" name="datum_aus_vsb_entlassen"/>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Objekterfassung" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="6" name="erfassungsdatum"/>
        <attributeEditorField showLabel="1" index="7" name="datenerfasser"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Dokumente" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_geogene_bodenbelastung_schdstffls_t_id"/>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Schadstoffe" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_geogene_bodenbelastung_schdstffls_t_id_1"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <widgets>
    <widget name="schdstffls_geogene_bodenbelastung_schdstffls_t_id">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
    <widget name="schdstffls_geogene_bodenbelastung_schdstffls_t_id_1">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
  ...
  <defaults>
    ...
    <default field="geologische_einheit" expression=""/>
