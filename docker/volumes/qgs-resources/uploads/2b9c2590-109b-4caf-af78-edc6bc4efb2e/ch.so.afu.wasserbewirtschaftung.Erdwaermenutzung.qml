...
<qgis version="2.18.20" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="verfahrensstand">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{1d34305f-a6b5-44e1-8288-88d97a1fe79b}">
      <rule filter="&quot;verfahrensstand&quot; = 'Grundwasserwärmepumpe bewilligt'" key="{a9239f9b-9794-4474-a87b-6e659d269ad1}" symbol="0" label="Grundwasserwärmepumpe bewilligt"/>
      <rule filter="&quot;verfahrensstand&quot; = 'neue_voranfrage'" key="{500924c0-df86-447e-bc83-0c26f98fbff2}" symbol="1" label="Grundwasserwärmepumpe Voranfrage neu"/>
      <rule filter="&quot;verfahrensstand&quot; = 'alte_voranfrage'" key="{9acbf48d-840e-4b4f-ab80-b5d015c51c90}" symbol="2" label="Grundwasserwärmepumpe Voranfrage alt (älter als 5 Jahre)"/>
      <rule filter="&quot;verfahrensstand&quot; = 'unbekannter_Verfahrensstand'" key="{53cdd98c-3aa5-4454-ad71-bc9fc016996a}" symbol="3" label="Grundwasserwärmepumpe unbekannter Verfahrensstand"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,160,246,255"/>
  ...
  <aliases>
    ...
    <alias field="verfahrensstand" index="2" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="verfahrensstand"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="verfahrensstand" expression=""/>
