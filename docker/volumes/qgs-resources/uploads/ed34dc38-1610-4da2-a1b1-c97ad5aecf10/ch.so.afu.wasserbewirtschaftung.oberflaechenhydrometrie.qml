...
<qgis version="2.18.20" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="hydrometrieobjekt">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="besitzer">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{1ffcadc0-1b12-4e96-bbf3-e7014ad581ac}">
      <rule filter="&quot;hydrometrieobjekt&quot; = 'Niederschlagsmessstation'" key="{7d7895c9-2c48-44db-a6c8-88796f05cab7}" symbol="0" label="Niederschlagsmessstation"/>
      <rule filter="&quot;hydrometrieobjekt&quot; = 'Oberflaechengewaessermessstation'" key="{b3275a54-55e0-4853-a3c0-07b2753b39f2}" symbol="1" label="Oberflaechengewaessermessstation"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="hydrometrieobjekt" index="2" name=""/>
    <alias field="besitzer" index="3" name=""/>
    <alias field="objekttyp_anzeige" index="4" name=""/>
    <alias field="objektname" index="5" name=""/>
    <alias field="objektnummer" index="6" name=""/>
    <alias field="technische_angabe" index="7" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-379610494">
    <columns>
      <column width="-1" hidden="0" type="field" name="t_id"/>
      <column width="-1" hidden="0" type="field" name="t_ili_tid"/>
      <column width="-1" hidden="0" type="field" name="hydrometrieobjekt"/>
      <column width="-1" hidden="0" type="field" name="besitzer"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="hydrometrieobjekt" expression=""/>
    <default field="besitzer" expression=""/>
