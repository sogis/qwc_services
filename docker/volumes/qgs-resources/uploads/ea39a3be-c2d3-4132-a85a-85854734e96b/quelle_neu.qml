...
<qgis version="2.18.20" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="anzeige_schuettung">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 attr="gefasst" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="f" label="ungefasst"/>
      <category render="true" symbol="1" value="t" label="gefasst"/>
    </categories>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="anzeige_schuettung" index="6" name=""/>
    <alias field="schutzzone" index="7" name=""/>
    <alias field="nutzungstyp" index="8" name=""/>
    <alias field="verwendungszweck" index="9" name=""/>
    <alias field="objekttyp_anzeige" index="10" name=""/>
    <alias field="objektname" index="11" name=""/>
    <alias field="objektnummer" index="12" name=""/>
    <alias field="technische_angabe" index="13" name=""/>
    <alias field="bemerkung" index="14" name=""/>
    <alias field="dokumente" index="15" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="anzeige_schuettung"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="anzeige_schuettung" expression=""/>
