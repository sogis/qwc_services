...
<qgis version="2.18.17" simplifyAlgorithm="0" minimumScale="0" maximumScale="6000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <labeling type="rule-based">
    <rules key="{824a104f-7b6b-461c-98a1-58b141ee1424}">
      <rule scalemaxdenom="300" description="1:250" key="{b9cb562c-29bb-44b6-b25d-6a2f94d5addd}" scalemindenom="1">
        <settings>
      ...
      <rule scalemaxdenom="750" description="1:500" key="{108e007b-7d3f-413d-a351-1e8a046775a9}" scalemindenom="300">
        <settings>
          <text-style fontItalic="1" fontFamily="Frutiger LT Com 55 Roman" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="12.6" fieldName="objektname" namedStyle="56 Italic" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
      ...
      <rule scalemaxdenom="1250" description="1:1000" key="{6ffc5369-7792-41bd-af4d-c82dc9f8aef5}" scalemindenom="750">
        <settings>
      ...
      <rule scalemaxdenom="3000" description="1:2000" key="{ddb34d98-edf6-42b8-b789-9f57f3a37b07}" scalemindenom="1250">
        <settings>
      ...
      <rule scalemaxdenom="6000" description="1:5000" key="{8fd8aabe-bed5-4c86-9c0b-44f6cde69c51}" scalemindenom="3000">
        <settings>
  ...
  <aliases>
    ...
    <alias field="herkunft" index="7" name=""/>
    <alias field="bfs_nr" index="8" name=""/>
    <alias field="importdatum" index="9" name=""/>
    <alias field="nachfuehrung" index="10" name=""/>
    <alias field="astatus" index="11" name=""/>
  </aliases>
