...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="stilllegungsjahr">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="kbs_nummer_so">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="kbs_nummer_vbs">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{ee4fd19b-4541-49f8-8212-e9f401f4a4bf}">
      <rule filter="&quot;begruendung_aus_vsb_entlassen&quot; is null" key="{819bbcd6-c49f-4996-a537-46984e675454}" symbol="0" label="Verdachtsfläche"/>
      <rule filter="&quot;astatus&quot; = 'Belastung_nachgewiesen' and  &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{131847c3-4ce3-440c-ba62-2f6dbeccaece}" symbol="1" label="Belastung nachgewiesen"/>
  ...
  <aliases>
    ...
    <alias field="name_schiessanlage" index="2" name="Name der Schiessanlage"/>
    <alias field="baujahr" index="3" name="Baujahr"/>
    <alias field="stilllegungsjahr" index="4" name="Jahr der Stillegung"/>
    <alias field="betriebsstatus" index="5" name="Betriebsstatus"/>
    <alias field="waffe" index="6" name="Waffen"/>
    <alias field="kbs_nummer_so" index="7" name="KbS-Nummer Kt. SO"/>
    <alias field="kbs_nummer_vbs" index="8" name="KbS-Nummer VBS"/>
    <alias field="betriebsstatus_txt" index="9" name=""/>
    <alias field="url_kbs" index="10" name=""/>
    <alias field="bezeichnung" index="11" name="Bezeichnung"/>
    <alias field="astatus" index="12" name="Status"/>
    <alias field="aktiv" index="13" name="aktiv?"/>
    <alias field="erfassungsdatum" index="14" name="Erfassungsdatum"/>
    <alias field="datenerfasser" index="15" name="Erfasser"/>
    <alias field="begruendung_aus_vsb_entlassen" index="16" name="Begründung aus VSB entlassen"/>
    <alias field="datum_aus_vsb_entlassen" index="17" name="Datum aus VSB entlassen"/>
    <alias field="bemerkung" index="18" name="Bemerkung"/>
    <alias field="nutzungseinschraenkung" index="19" name="Nutzungseinschränkung"/>
    <alias field="dokument" index="20" name=""/>
    <alias field="schadstoffe" index="21" name=""/>
    <alias field="bfs_gemeindenummern" index="22" name=""/>
    <alias field="gemeindenamen" index="23" name=""/>
    <alias field="grundbuchnummern" index="24" name=""/>
    <alias field="flurnamen" index="25" name=""/>
    <alias field="nutzungsverbot" index="26" name="Nutzungsverbot"/>
    <alias field="status_txt" index="27" name=""/>
    <alias field="begruendung_aus_vsb_entlassen_txt" index="28" name=""/>
    <alias field="flaeche" index="29" name=""/>
    <alias field="umfang" index="30" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;waffe&quot;" sortOrder="1">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="stilllegungsjahr"/>
      <column width="-1" hidden="0" type="field" name="betriebsstatus"/>
      <column width="346" hidden="0" type="field" name="waffe"/>
      ...
      <column width="-1" hidden="0" type="field" name="kbs_nummer_so"/>
      <column width="-1" hidden="0" type="field" name="kbs_nummer_vbs"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Allgemein" groupBox="0" columnCount="1">
      <attributeEditorField showLabel="1" index="11" name="bezeichnung"/>
      <attributeEditorField showLabel="1" index="2" name="name_schiessanlage"/>
      <attributeEditorField showLabel="1" index="5" name="betriebsstatus"/>
      <attributeEditorField showLabel="1" index="3" name="baujahr"/>
      <attributeEditorField showLabel="1" index="4" name="stilllegungsjahr"/>
      <attributeEditorField showLabel="1" index="6" name="waffe"/>
      <attributeEditorField showLabel="1" index="8" name="kbs_nummer_vbs"/>
      <attributeEditorField showLabel="1" index="7" name="kbs_nummer_so"/>
      <attributeEditorField showLabel="1" index="12" name="astatus"/>
      <attributeEditorField showLabel="1" index="13" name="aktiv"/>
      <attributeEditorField showLabel="1" index="19" name="nutzungseinschraenkung"/>
      <attributeEditorField showLabel="1" index="26" name="nutzungsverbot"/>
      <attributeEditorField showLabel="1" index="18" name="bemerkung"/>
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="&quot;astatus&quot;" name="aus VSB entlassen" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="16" name="begruendung_aus_vsb_entlassen"/>
        <attributeEditorField showLabel="1" index="17" name="datum_aus_vsb_entlassen"/>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Objekterfassung" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="14" name="erfassungsdatum"/>
        <attributeEditorField showLabel="1" index="15" name="datenerfasser"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Schadstoffe" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_militaerischer_schiessplatz_schdstffls_t_id_1"/>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Dokumente" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_militaerischer_schiessplatz_schdstffls_t_id"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <widgets>
    <widget name="schdstffls_militaerischer_schiessplatz_schdstffls_t_id">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
    <widget name="schdstffls_militaerischer_schiessplatz_schdstffls_t_id_1">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
  ...
  <defaults>
    ...
    <default field="stilllegungsjahr" expression=""/>
    <default field="betriebsstatus" expression=""/>
    <default field="waffe" expression=""/>
    <default field="kbs_nummer_so" expression=""/>
    <default field="kbs_nummer_vbs" expression=""/>
