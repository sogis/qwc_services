...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="einzelschutz">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <aliases>
    ...
    <alias field="nsi_nummer" index="3" name=""/>
    <alias field="aname" index="4" name=""/>
    <alias field="beschreibung" index="5" name=""/>
    <alias field="flaeche" index="6" name=""/>
    <alias field="teilgebietsnamen" index="7" name=""/>
    <alias field="gemeinden" index="8" name=""/>
    <alias field="dokumente" index="9" name=""/>
    <alias field="zustaendiger" index="10" name=""/>
    <alias field="einzelschutz" index="11" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="einzelschutz"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="einzelschutz" expression=""/>
  </defaults>
