...
<qgis version="2.18.20" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{8769147c-e9b0-4099-89b2-b343e5ab842d}">
      <rule filter="&quot;objektart&quot; = 'Grundwasserbeobachtung.Sondierung.Bohrung'" key="{2dff9eb6-ca2d-4d9a-94b5-6029d305caec}" symbol="0" label="Bohrung"/>
      <rule filter="&quot;objektart&quot; = 'Grundwasserbeobachtung.Piezometer.Bohrung'" key="{a9394453-cc68-4e89-b13f-4faa0c272b02}" symbol="1" label="Bohrung mit Piezometer"/>
      <rule filter="&quot;objektart&quot; = 'Grundwasserbeobachtung.Sondierung.Baggerschlitz'" key="{4ba1b4ce-53e0-4254-8363-76717f755e1d}" symbol="2" label="Baggerschlitz"/>
      <rule filter="&quot;objektart&quot; = 'Grundwasserbeobachtung.Piezometer.Gerammt'" key="{b31885f2-ce3c-4996-be75-a6ed149df79a}" symbol="3" label="Gerammtes Piezometer"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,4,0,255"/>
  ...
  <aliases>
    ...
    <alias field="objektart" index="2" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="objektart"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="objektart" expression=""/>
