...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="nutzungsbeginn">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="nutzungsende">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{7c4cdabb-5971-4542-9a61-38653e847956}">
      <rule filter="&quot;begruendung_aus_vsb_entlassen&quot; is null" key="{38b25843-7b61-472f-93e8-334c7aa87f3e}" symbol="0" label="Verdachtsfläche"/>
      <rule filter="&quot;astatus&quot; = 'Belastung_nachgewiesen' and  &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{9960a728-9dbe-45a1-8fd1-7683f585db41}" symbol="1" label="Belastung nachgewiesen"/>
      <rule filter=" &quot;nutzungseinschraenkung&quot;  =  'true' and  &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{39ee763f-dea3-452d-8ff4-6ada8643145a}" symbol="2" label="Nutzungseinschränkung"/>
      <rule filter="&quot;nutzungsverbot&quot; = 'true' and  &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{2a1296f8-b308-4e38-b009-c6617bf3864e}" symbol="3" label="Nutzungsverbot"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="objektname" index="2" name="Name"/>
    <alias field="nutzungsbeginn" index="3" name="Beginn der Nutzung (Jahr)"/>
    <alias field="nutzungsende" index="4" name="Ende der Nutzung (Jahr)"/>
    <alias field="bezeichnung" index="5" name="Bezeichnung"/>
    <alias field="astatus" index="6" name="Status"/>
    <alias field="aktiv" index="7" name="aktiv?"/>
    <alias field="erfassungsdatum" index="8" name="Erfassungsdatum"/>
    <alias field="datenerfasser" index="9" name="Erfasser"/>
    <alias field="begruendung_aus_vsb_entlassen" index="10" name="Begründung aus VSB entlassen"/>
    <alias field="datum_aus_vsb_entlassen" index="11" name="Datum aus VSB entlassen"/>
    <alias field="bemerkung" index="12" name="Bemerkung"/>
    <alias field="nutzungseinschraenkung" index="13" name="Nutzungseinschränkung"/>
    <alias field="dokument" index="14" name=""/>
    <alias field="schadstoffe" index="15" name=""/>
    <alias field="bfs_gemeindenummern" index="16" name=""/>
    <alias field="gemeindenamen" index="17" name=""/>
    <alias field="grundbuchnummern" index="18" name=""/>
    <alias field="flurnamen" index="19" name=""/>
    <alias field="nutzungsverbot" index="20" name="Nutzungsverbot"/>
    <alias field="status_txt" index="21" name=""/>
    <alias field="begruendung_aus_vsb_entlassen_txt" index="22" name=""/>
    <alias field="flaeche" index="23" name=""/>
    <alias field="umfang" index="24" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;aktiv&quot;" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="nutzungsbeginn"/>
      <column width="-1" hidden="0" type="field" name="nutzungsende"/>
      ...
      <column width="411" hidden="0" type="field" name="bemerkung"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Allgemein" groupBox="0" columnCount="1">
      <attributeEditorField showLabel="1" index="5" name="bezeichnung"/>
      <attributeEditorField showLabel="1" index="2" name="objektname"/>
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="" groupBox="1" columnCount="3">
        <attributeEditorField showLabel="1" index="3" name="nutzungsbeginn"/>
        <attributeEditorField showLabel="1" index="4" name="nutzungsende"/>
      </attributeEditorContainer>
      <attributeEditorField showLabel="1" index="-1" name="flaechentyp"/>
      <attributeEditorField showLabel="1" index="6" name="astatus"/>
      <attributeEditorField showLabel="1" index="7" name="aktiv"/>
      <attributeEditorField showLabel="1" index="13" name="nutzungseinschraenkung"/>
      <attributeEditorField showLabel="1" index="20" name="nutzungsverbot"/>
      <attributeEditorField showLabel="1" index="12" name="bemerkung"/>
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="&quot;astatus&quot;" name="aus VSB entlassen" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="10" name="begruendung_aus_vsb_entlassen"/>
        <attributeEditorField showLabel="1" index="11" name="datum_aus_vsb_entlassen"/>
      </attributeEditorContainer>
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Objekterfassung" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="8" name="erfassungsdatum"/>
        <attributeEditorField showLabel="1" index="9" name="datenerfasser"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Schadstoffe" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_gartenbau_schdstffls_t_id_1"/>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Dokumente" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_gartenbau_schdstffls_t_id"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <widgets>
    <widget name="schdstffls_gartenbau_schdstffls_t_id">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
    <widget name="schdstffls_gartenbau_schdstffls_t_id_1">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
  ...
  <defaults>
    ...
    <default field="nutzungsbeginn" expression=""/>
    <default field="nutzungsende" expression=""/>
