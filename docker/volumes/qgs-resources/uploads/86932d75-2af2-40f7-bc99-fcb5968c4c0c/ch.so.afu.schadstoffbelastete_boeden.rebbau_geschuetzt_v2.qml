...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias field="nutzungsbeginn" index="2" name="Nutzungsbeginn (Jahr)"/>
    <alias field="nutzungsende" index="3" name="Nutzungsende (Jahr)"/>
    <alias field="bezeichnung" index="4" name="Bezeichnung"/>
    <alias field="astatus" index="5" name="Status"/>
    <alias field="aktiv" index="6" name="altiv?"/>
    <alias field="erfassungsdatum" index="7" name="Erfassungsdatum"/>
    <alias field="datenerfasser" index="8" name="Erfasser"/>
    <alias field="begruendung_aus_vsb_entlassen" index="9" name="Begründung aus VSB entlassen"/>
    <alias field="datum_aus_vsb_entlassen" index="10" name="Datum aus VSB entlassen"/>
    <alias field="bemerkung" index="11" name="Bemerkung"/>
    <alias field="nutzungseinschraenkung" index="12" name="Nutzungseinschränkung"/>
    <alias field="dokument" index="13" name=""/>
    <alias field="schadstoffe" index="14" name=""/>
    <alias field="bfs_gemeindenummern" index="15" name=""/>
    <alias field="gemeindenamen" index="16" name=""/>
    <alias field="grundbuchnummern" index="17" name=""/>
    <alias field="flurnamen" index="18" name=""/>
    <alias field="nutzungsverbot" index="19" name="Nutzungsverbot"/>
    <alias field="status_txt" index="20" name=""/>
    <alias field="begruendung_aus_vsb_entlassen_txt" index="21" name=""/>
    <alias field="flaeche" index="22" name=""/>
    <alias field="umfang" index="23" name=""/>
  </aliases>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Allgemein" groupBox="0" columnCount="1">
      <attributeEditorField showLabel="1" index="4" name="bezeichnung"/>
      <attributeEditorField showLabel="1" index="-1" name="anbautyp"/>
      <attributeEditorField showLabel="1" index="2" name="nutzungsbeginn"/>
      <attributeEditorField showLabel="1" index="3" name="nutzungsende"/>
      <attributeEditorField showLabel="1" index="5" name="astatus"/>
      <attributeEditorField showLabel="1" index="6" name="aktiv"/>
      <attributeEditorField showLabel="1" index="12" name="nutzungseinschraenkung"/>
      <attributeEditorField showLabel="1" index="19" name="nutzungsverbot"/>
      <attributeEditorField showLabel="1" index="11" name="bemerkung"/>
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="&quot;aktiv&quot; = 'false'" name=" aus VSB entlassen" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="9" name="begruendung_aus_vsb_entlassen"/>
        <attributeEditorField showLabel="1" index="10" name="datum_aus_vsb_entlassen"/>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Objekterfassung" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="7" name="erfassungsdatum"/>
        <attributeEditorField showLabel="1" index="8" name="datenerfasser"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
