...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="1" type="RuleRenderer" enableorderby="0">
    <rules key="{5595a8e4-b9ec-499a-90af-7f54636d2791}">
      <rule filter="typ = 'S1'" key="{a103bb95-0a2b-4b0e-82cd-c6d6b859538b}" symbol="0" label="Grundwasserschutzzone S1"/>
      <rule filter="typ = 'S2'" key="{11f6b661-ac2b-494f-800e-3f29f687247b}" symbol="1" label="Grundwasserschutzzone S2"/>
      <rule filter="typ = 'S3'" key="{7ada11f0-a77e-4f74-8346-d25b8d081f26}" symbol="2" label="Grundwasserschutzzone S3"/>
      <rule filter=" typ = 'Areal'" key="{aa5644b1-1d2c-4ab6-9c7d-2e7ba4e3fbe2}" symbol="3" label="Grundwasserschutzareal"/>
    </rules>
    <symbols>
