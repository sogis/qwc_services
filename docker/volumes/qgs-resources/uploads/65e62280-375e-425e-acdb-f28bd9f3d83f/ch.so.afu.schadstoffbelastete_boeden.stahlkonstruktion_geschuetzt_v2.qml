...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="stahlkonstruktionsname">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="eigentuemer">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="stahlkonstruktionstyp">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{88f2b973-92ab-4805-84ed-2cbc035f5227}">
      <rule filter="&quot;begruendung_aus_vsb_entlassen&quot; is null" key="{eb467399-9de6-4259-876d-7c7a6e8d86f8}" symbol="0" label="Verdachtsfläche"/>
      <rule filter="&quot;astatus&quot; = 'Belastung_nachgewiesen' and  &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{92b75617-5426-4778-99b5-fd27b32a9ab0}" symbol="1" label="Belastung nachgewiesen"/>
      <rule filter=" &quot;nutzungseinschraenkung&quot;  =  'true' and &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{22129fe3-c3a3-4f42-8030-ce9000aaf294}" symbol="2" label="Nutzungseinschränkung"/>
      <rule filter=" &quot;nutzungsverbot&quot;  =  'true' and &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{e5be2729-dcab-428f-a4b7-4432c5d4ddf6}" symbol="3" label="Nutzungsverbot"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="143,33,136,255"/>
  ...
  <displayfield>stahlkonstruktionsname</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    ...
    <alias field="stahlkonstruktionsname" index="2" name="Name der Stahlkonstruktion"/>
    <alias field="eigentuemer" index="3" name="Eigentümer"/>
    <alias field="stahlkonstruktionstyp" index="4" name=""/>
    <alias field="betriebsstatus" index="5" name="Betriebsstatus"/>
    <alias field="baujahr" index="6" name="Baujahr"/>
    <alias field="bezeichnung" index="7" name="Bezeichnung"/>
    <alias field="astatus" index="8" name="Status"/>
    <alias field="aktiv" index="9" name="aktiv?"/>
    <alias field="erfassungsdatum" index="10" name="Erfassungsdatum"/>
    <alias field="datenerfasser" index="11" name="Erfasser"/>
    <alias field="begruendung_aus_vsb_entlassen" index="12" name="Begründung aus VSB entlassen"/>
    <alias field="datum_aus_vsb_entlassen" index="13" name="Datum aus VSB entlassen"/>
    <alias field="bemerkung" index="14" name="Bemerkung"/>
    <alias field="nutzungseinschraenkung" index="15" name="Nutzungseinschränkung"/>
    <alias field="dokument" index="16" name=""/>
    <alias field="schadstoffe" index="17" name=""/>
    <alias field="bfs_gemeindenummern" index="18" name=""/>
    <alias field="gemeindenamen" index="19" name=""/>
    <alias field="grundbuchnummern" index="20" name=""/>
    <alias field="flurnamen" index="21" name=""/>
    <alias field="nutzungsverbot" index="22" name="Nutzungsverbot"/>
    <alias field="status_txt" index="23" name=""/>
    <alias field="begruendung_aus_vsb_entlassen_txt" index="24" name=""/>
    <alias field="flaeche" index="25" name=""/>
    <alias field="umfang" index="26" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="stahlkonstruktionsname"/>
      ...
      <column width="227" hidden="0" type="field" name="bezeichnung"/>
      ...
      <column width="-1" hidden="0" type="field" name="stahlkonstruktionstyp"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Allgemein" groupBox="0" columnCount="1">
      <attributeEditorField showLabel="1" index="7" name="bezeichnung"/>
      <attributeEditorField showLabel="1" index="2" name="stahlkonstruktionsname"/>
      <attributeEditorField showLabel="1" index="-1" name="typ"/>
      <attributeEditorField showLabel="1" index="3" name="eigentuemer"/>
      <attributeEditorField showLabel="1" index="6" name="baujahr"/>
      <attributeEditorField showLabel="1" index="5" name="betriebsstatus"/>
      <attributeEditorField showLabel="1" index="8" name="astatus"/>
      <attributeEditorField showLabel="1" index="9" name="aktiv"/>
      <attributeEditorField showLabel="1" index="15" name="nutzungseinschraenkung"/>
      <attributeEditorField showLabel="1" index="22" name="nutzungsverbot"/>
      <attributeEditorField showLabel="1" index="14" name="bemerkung"/>
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="&quot;astatus&quot;" name="aus VSB entlassen" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="12" name="begruendung_aus_vsb_entlassen"/>
        <attributeEditorField showLabel="1" index="13" name="datum_aus_vsb_entlassen"/>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Objekterfassung" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="10" name="erfassungsdatum"/>
        <attributeEditorField showLabel="1" index="11" name="datenerfasser"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Schadstoffe" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_stahlkonstruktion_schdstffls_t_id_1"/>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Dokumente" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_stahlkonstruktion_schdstffls_t_id"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <widgets>
    <widget name="schdstffls_stahlkonstruktion_schdstffls_t_id">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
    <widget name="schdstffls_stahlkonstruktion_schdstffls_t_id_1">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
    <widget name="schdstffls_t_id_schdstffls_typ">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
  ...
  <defaults>
    ...
    <default field="stahlkonstruktionsname" expression=""/>
    <default field="eigentuemer" expression=""/>
    <default field="stahlkonstruktionstyp" expression=""/>
