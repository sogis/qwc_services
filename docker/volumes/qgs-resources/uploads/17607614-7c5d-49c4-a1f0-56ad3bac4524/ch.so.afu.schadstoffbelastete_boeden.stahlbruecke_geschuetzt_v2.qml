...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="brueckenname">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="eigentuemer">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="brueckentyp">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="betriebsstatus">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="brueckentyp_txt">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;aktiv&quot;" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="brueckenname"/>
      <column width="-1" hidden="0" type="field" name="eigentuemer"/>
      <column width="-1" hidden="0" type="field" name="brueckentyp"/>
      <column width="-1" hidden="0" type="field" name="betriebsstatus"/>
      <column width="-1" hidden="0" type="field" name="brueckentyp_txt"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="brueckenname" expression=""/>
    <default field="eigentuemer" expression=""/>
    <default field="brueckentyp" expression=""/>
    <default field="betriebsstatus" expression=""/>
    <default field="brueckentyp_txt" expression=""/>
