...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="100000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{30914648-54a7-469e-b93d-99a095eb1123}">
      <rule key="{3b3420d7-cf9c-4388-9387-6d7062da2bcb}" symbol="0" label="Stahlbrücke"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="bezeichnung" index="7" name=""/>
    <alias field="astatus" index="8" name=""/>
    <alias field="aktiv" index="9" name=""/>
    <alias field="erfassungsdatum" index="10" name=""/>
    <alias field="datenerfasser" index="11" name=""/>
    <alias field="begruendung_aus_vsb_entlassen" index="12" name=""/>
    <alias field="datum_aus_vsb_entlassen" index="13" name=""/>
    <alias field="bemerkung" index="14" name=""/>
    <alias field="nutzungseinschraenkung" index="15" name=""/>
    ...
    <alias field="nutzungsverbot" index="20" name=""/>
