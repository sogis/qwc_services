...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="100000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{abe015a3-1f83-4c99-8ba9-7d5e52d811d5}">
      <rule key="{8257e7f3-cff8-4aea-aadc-63652131a122}" symbol="0" label="Siedlungsgebiet"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="astatus" index="3" name=""/>
    <alias field="aktiv" index="4" name=""/>
    <alias field="erfassungsdatum" index="5" name=""/>
    <alias field="datenerfasser" index="6" name=""/>
    <alias field="begruendung_aus_vsb_entlassen" index="7" name=""/>
    <alias field="datum_aus_vsb_entlassen" index="8" name=""/>
    <alias field="bemerkung" index="9" name=""/>
    <alias field="nutzungseinschraenkung" index="10" name=""/>
    <alias field="bfs_gemeindenummern" index="11" name=""/>
    <alias field="gemeindenamen" index="12" name=""/>
    <alias field="grundbuchnummern" index="13" name=""/>
    <alias field="flurnamen" index="14" name=""/>
    <alias field="nutzungsverbot" index="15" name=""/>
    <alias field="status_txt" index="16" name=""/>
    <alias field="begruendung_aus_vsb_entlassen_txt" index="17" name=""/>
  </aliases>
