...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="mastnummer">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="leitungsnummer">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="leitung_von">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="leitung_bis">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="radius_txt">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{c04f8ec3-ccf6-49c0-8b87-66b629b92473}">
      <rule filter=" &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{50fc1723-d0f2-48ba-a4c7-6e816dc1fafc}" symbol="0" label="Verdachtsfläche"/>
      <rule filter="&quot;astatus&quot; = 'Belastung_nachgewiesen' and  &quot;begruendung_aus_vsb_entlassen&quot; is null" key="{3c0e96e7-6394-4c87-87c5-6844cef7532a}" symbol="1" label="Belastung nachgewiesen"/>
  ...
  <aliases>
    ...
    <alias field="eigentuemer" index="2" name=""/>
    <alias field="baujahr" index="3" name=""/>
    <alias field="mastnummer" index="4" name=""/>
    <alias field="betriebsstatus" index="5" name=""/>
    <alias field="radius" index="6" name=""/>
    <alias field="leitungsnummer" index="7" name=""/>
    <alias field="leitung_von" index="8" name=""/>
    <alias field="leitung_bis" index="9" name=""/>
    <alias field="radius_txt" index="10" name=""/>
    <alias field="bezeichnung" index="11" name="Bezeichnung"/>
    <alias field="astatus" index="12" name="Status"/>
    <alias field="aktiv" index="13" name="altiv?"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;aktiv&quot;" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="t_id"/>
      <column width="-1" hidden="0" type="field" name="t_ili_tid"/>
      <column width="243" hidden="0" type="field" name="bezeichnung"/>
      ...
      <column width="-1" hidden="0" type="field" name="mastnummer"/>
      <column width="-1" hidden="0" type="field" name="radius"/>
      <column width="-1" hidden="0" type="field" name="leitungsnummer"/>
      <column width="-1" hidden="0" type="field" name="leitung_von"/>
      <column width="-1" hidden="0" type="field" name="leitung_bis"/>
      <column width="-1" hidden="0" type="field" name="radius_txt"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Allgemein" groupBox="0" columnCount="1">
      ...
      <attributeEditorField showLabel="1" index="-1" name="anbautyp"/>
      <attributeEditorField showLabel="1" index="-1" name="nutzungsbeginn"/>
      <attributeEditorField showLabel="1" index="-1" name="nutzungsende"/>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="&quot;aktiv&quot; = 'false'" name=" aus VSB entlassen" groupBox="1" columnCount="2">
    ...
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Schadstoffe" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_anbaugebiet_schdstffls_t_id_1"/>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Dokumente" groupBox="0" columnCount="1">
      <attributeEditorRelation showLinkButton="1" relation="" showLabel="1" showUnlinkButton="1" name="schdstffls_anbaugebiet_schdstffls_t_id"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <widgets>
    <widget name="schdstffls_anbaugebiet_schdstffls_t_id">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
    <widget name="schdstffls_anbaugebiet_schdstffls_t_id_1">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
    <widget name="schdstffls_stahlbruecke_schdstffls_t_id">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
    <widget name="schdstffls_stahlbruecke_schdstffls_t_id_1">
      <config>
        <option key="type" value="Map"/>
      </config>
    </widget>
  ...
  <defaults>
    ...
    <default field="mastnummer" expression=""/>
    <default field="betriebsstatus" expression=""/>
    <default field="radius" expression=""/>
    <default field="leitungsnummer" expression=""/>
    <default field="leitung_von" expression=""/>
    <default field="leitung_bis" expression=""/>
    <default field="radius_txt" expression=""/>
