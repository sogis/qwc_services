...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="objekttyp" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      ...
      <category render="true" symbol="2" value="kantonales_Vorranggebiet" label="kantonales_Vorranggebiet"/>
      <category render="true" symbol="3" value="Siedlungstrennguertel" label="Siedlungstrennguertel"/>
      <category render="true" symbol="4" value="Witischutzzone" label="Witischutzzone"/>
    </categories>
    <symbols>
