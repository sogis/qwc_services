...
<qgis version="2.18.17" simplifyAlgorithm="0" minimumScale="1" maximumScale="3000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <labeling type="rule-based">
    <rules key="{035bf54b-0977-43ad-8efb-a9bb6da97096}">
      <rule scalemaxdenom="300" description="1:250" key="{8b0a9b98-62eb-4231-bf78-df286617cfdd}" scalemindenom="1">
        <settings>
      ...
      <rule scalemaxdenom="750" description="1:500" key="{48a01029-7c0a-4d8c-b78e-29b7972a033a}" scalemindenom="300">
        <settings>
          <text-style fontItalic="1" fontFamily="Frutiger LT Com 55 Roman" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="12.6" fieldName="objektname" namedStyle="56 Italic" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
      ...
      <rule scalemaxdenom="1250" description="1:1000" key="{264ebe10-316f-431a-98c9-9de685011d18}" scalemindenom="750">
        <settings>
      ...
      <rule scalemaxdenom="3000" description="1:2000" key="{4a0732fc-6932-4dad-96be-091feb646cfd}" scalemindenom="1250">
        <settings>
