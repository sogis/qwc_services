...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="posten_nummer">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="wanderweg">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="pfad">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="posten_nummer"/>
  ...
  <aliases>
    ...
    <alias field="posten_nummer" index="2" name=""/>
    <alias field="wanderweg" index="3" name=""/>
    <alias field="pfad" index="4" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="posten_nummer"/>
      <column width="-1" hidden="0" type="field" name="wanderweg"/>
      <column width="-1" hidden="0" type="field" name="pfad"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="posten_nummer" expression=""/>
    <default field="wanderweg" expression=""/>
    <default field="pfad" expression=""/>
  </defaults>
