...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{217cd246-d772-4e79-b252-c69077911f34}">
      <rule filter="gefasst = 'f' OR gefasst = 'false'" key="{8e56d185-bf84-4196-9ff2-5aa8e0f1c095}" symbol="0" label="ungefasst"/>
      <rule filter="gefasst = 't' OR gefasst = 'true'" key="{80875508-9256-4f8b-a4ce-b95cebb5e2e6}" symbol="1" label="gefasst"/>
    </rules>
    <symbols>
