...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="100000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{ef7d4edb-6e61-4c13-9da2-3340abe6e5d2}">
      <rule key="{42b2f6b7-92cb-485a-947c-a96375843e9a}" symbol="0" label="Hopfenbau"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="nutzungsbeginn" index="2" name=""/>
    <alias field="nutzungsende" index="3" name=""/>
    <alias field="bezeichnung" index="4" name=""/>
    <alias field="astatus" index="5" name=""/>
    <alias field="aktiv" index="6" name=""/>
    <alias field="erfassungsdatum" index="7" name=""/>
    <alias field="datenerfasser" index="8" name=""/>
    <alias field="begruendung_aus_vsb_entlassen" index="9" name=""/>
    <alias field="datum_aus_vsb_entlassen" index="10" name=""/>
    <alias field="bemerkung" index="11" name=""/>
    <alias field="nutzungseinschraenkung" index="12" name=""/>
    ...
    <alias field="nutzungsverbot" index="17" name=""/>
