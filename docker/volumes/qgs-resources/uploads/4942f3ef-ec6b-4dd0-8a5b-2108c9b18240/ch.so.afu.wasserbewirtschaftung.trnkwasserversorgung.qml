...
<qgis version="2.18.20" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="trinkwasserobjektart">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{a8561b6c-f183-42d4-b4c4-d0380ab7728e}">
      <rule filter="&quot;trinkwasserobjektart&quot; = 'Reservoir'" key="{42c2e7cb-98b0-4e8e-a385-eff0e5f483cb}" symbol="0" label="Reservoir"/>
      <rule filter="&quot;trinkwasserobjektart&quot; = 'Pumpwerk'" key="{183a3c84-1920-447e-93ad-0b540cdcf50a}" symbol="1" label="Pumpwerk"/>
      <rule filter="&quot;trinkwasserobjektart&quot; = 'Netzmessstelle'" key="{17d23718-b6a8-4233-9a8d-5d976ffd96d6}" symbol="2" label="Netzmessstelle"/>
      <rule filter="&quot;trinkwasserobjektart&quot; = 'Quellwasserbehaelter'" key="{ccbab229-ec14-4a4f-885f-98e9a26345d7}" symbol="3" label="Quellwasserbehaelter"/>
      <rule filter="&quot;trinkwasserobjektart&quot; = 'Sammelbrunnenstube'" key="{1a5e2432-cb30-4867-994f-067b4788dc6f}" symbol="4" label="Sammelbrunnenstube"/>
      <rule filter="&quot;trinkwasserobjektart&quot; = 'Kontrollschacht'" key="{ebe2fa40-407d-4601-93c0-a3c9908c2bf1}" symbol="5" label="Kontrollschacht"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="234,109,28,255"/>
  ...
  <aliases>
    ...
    <alias field="trinkwasserobjektart" index="2" name=""/>
    <alias field="objekttyp_anzeige" index="3" name=""/>
    <alias field="objektname" index="4" name=""/>
    <alias field="objektnummer" index="5" name=""/>
    <alias field="technische_angabe" index="6" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="trinkwasserobjektart"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="trinkwasserobjektart" expression=""/>
